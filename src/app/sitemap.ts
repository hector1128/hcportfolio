...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticUrls: MetadataRoute.Sitemap = [
    { url: `${base}/`, lastModified: new Date("2025-10-0"), changeFrequency: "weekly", priority: 1 },
    { url: `${base}/about`, lastModified: new Date("2025-17-05"), changeFrequency: "monthly", priority: 0.8 },
